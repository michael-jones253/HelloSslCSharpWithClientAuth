...
namespace HelloSslClient
{
    public class SslTcpClient
    {
        ...
        public SslTcpClient(string serverName, string certificate, string machineName, string password)
        {
            ...
            mClientCertificates = new X509Certificate2Collection(certCollection);
        }
        ...
        public void RunClient(int port)
        {
            ...
            TcpClient client = new TcpClient(mServerName, port);
            ...
            try
            {
                sslStream.AuthenticateAsClient(mMachineName, mClientCertificates, SslProtocols.Tls, false);
            }
            ...
            byte[] messsage = Encoding.UTF8.GetBytes("Hello world from the client.<EOF>");
