...
namespace Examples.System.Net
{
    public sealed class SslTcpServer
    {
        ...
        void ProcessClient(TcpClient client)
        {
            ...
            try
            {
                sslStream.AuthenticateAsServer(mCertificate,
                    mAuthClient, // client cert required
                    SslProtocols.Tls,
                    mCheckRevoke); // check cert revocation.
            ...
            {
                Console.WriteLine("Session over - closing the connection. {0}", ex.Message);
            }
            finally
            {
              ...
              SslPolicyErrors sslPolicyErrors)
        {
            ...
            {
                Console.WriteLine("HELLO, NO POLICY ERRORS!");
                return true;
            }
            ...
            if (sslPolicyErrors == SslPolicyErrors.RemoteCertificateChainErrors)
            {
                ...
                {
                    Console.WriteLine("Accepting client status of: {0}", err.StatusInformation);
                }

                return true;
            }

            Console.WriteLine("Failing client validation {0}: ", sslPolicyErrors);
            return false;
        }
    }
}